...
\]
ovvero il segnale in uscita è proporzionale alla differenza tra i segnali in ingresso. Pertanto si costruirà un circuito in cui i valori di $R_1$ e $R_1'$ e di $R_2$ e $R_2'$ siano il più simili possibile, e si sceglierà $R_2 / R_1 =: G = 5$. 
...
\end{aligned}
\]
compatibili con i valori attesi dati i componenti usati $A_1 = 111 \pm 111$ e $A_2 = 111 \pm 111$. Il valore medio dell'amplificazione differenziale, con associata incertezza data dalla deviazione standard, è
\[
A_d = 111 \pm 111,
\]
compatibile con il valore atteso dati i componenti di $A_d = 111 \pm 111$. Si può confrontare anche il valore misurato di $A_c$ con quello atteso $A_c = A_1 + A_2 = 111 \pm 111$, osservando che essi sono compatibili.
...
\]
compatibile con il valore atteso di $\rho = 111 \pm 111$. Si osserva che questo valore è molto elevato, infatti nell'amplificatore differenziale ideale si dovrebbe avere $\rho \rightarrow \infty$.
