...
$f$ [\SI{}{kHz}] & $v_1$ ($v_2 = 0$) [\SI{}{V}] & $v_o$ ($v_2 = 0$) [\SI{}{V}] & $v_2$ ($v_1 = 0$) [\SI{}{V}] & $v_o$ ($v_1 = 0$) [\SI{}{V}] & $A_1$ & $A_2$ & $A_d$\\
\hline
\hline
\end{tabular}
\end{center}
...
\]
e si osserva che sono compatibili. Si riporta in figura~\ref{fig:battimenti_ingresso} lo screenshot per i due segnali in ingresso: si nota che essi hanno frequenza di poco differente, osservando lo sfasamento progressivo lungo la schermata dei massimi. Si riporta invece in figura~\ref{fig:battimenti_uscita} lo screenshot del segnale in uscita: è evidente l'inviluppo dei due, che procede alla frequenza $f_\text{inv}$ stimata precedentemente.
